-- ============================================================================
-- Migration: Consolidate and Fix RLS Policies
-- Date: 2026-01-29
-- Purpose: Fix RLS context variable mismatch and standardize all policies
-- Critical: This migration MUST run after all existing migrations
-- ============================================================================
