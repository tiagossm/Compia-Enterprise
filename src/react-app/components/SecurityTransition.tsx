...
export default function SecurityTransition() {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-[#F8FAFC] flex flex-col font-sans">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center flex-1 w-full p-4">
                ...
                <div className="relative mb-12">
                    ...
                    <div className="relative bg-white p-6 rounded-full shadow-xl shadow-slate-200 border border-slate-100">
                        <ShieldCheck className="w-16 h-16 text-primary animate-pulse" strokeWidth={1.5} />
                    </div>
            ...
            {/* Footer: Educational Tip - Fixed at bottom but part of flex flow to strictly separate from content */}
            <div className="relative z-10 w-full flex flex-col items-center pb-8 px-6">
                <div className="bg-white/80 backdrop-blur-sm border border-slate-200 rounded-lg p-3 shadow-sm max-w-sm text-center">
