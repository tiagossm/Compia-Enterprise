-- ============================================================================
-- Migration: Fix RLS Policies for Checklist Tables
-- Date: 2026-01-30
-- Purpose: Add missing RLS policies for checklist_folders and checklist_templates
--          Currently these tables have RLS enabled but NO policies, blocking all access
-- ============================================================================
...
CREATE POLICY "checklist_templates_update" ON public.checklist_templates
    FOR UPDATE USING (
        ...
        created_by = COALESCE(auth.uid(), current_user_id())
    );
